...
exports.getUserDefinedAssertions = getUserDefinedAssertions;
exports.hasUserAssertionSupport = hasUserAssertionSupport;
/**
...
function getUserDefinedAssertions(sessionId, _db) {
    // Phase 2 stub — no user_assertions table exists yet
    void sessionId;
    return [];
}
/**
...
function hasUserAssertionSupport(_db) {
    // Returns false until the Phase 2 migration adds the user_assertions table
    return false;
}

...
export type ActionType = 'click' | 'input' | 'submit' | 'custom-control-open' | 'custom-select' | 'custom-menu-select' | 'hover' | 'scroll' | 'navigate';
export type OutcomeType = 'navigation' | 'no_change' | 'state_refresh' | 'immediate_action';
export type SelectorPriority = 'data-testid' | 'id' | 'attribute' | 'class' | 'path' | 'text' | 'xpath' | 'other' | 'chained' | 'unknown';
export type SelectorEngine = 'css' | 'xpath' | 'text' | 'testid' | 'role' | 'label' | 'scoped' | 'label-context' | 'trigger-context' | 'bounded-field' | 'placeholder' | 'playwright';
export type SelectorSource = 'interceptor' | 'resolver' | 'llm' | 'manual' | 'codegen' | 'smoke-repair';
export type SelectorProofLevel = 'recorded' | 'snapshot_validated' | 'semantic_validated' | 'live_smoke_validated' | 'proven_equivalent' | 'inferred_unproven' | 'weak_but_usable' | 'blocked' | 'unvalidated';
export type LabelContextRenderStatus = 'clean-direct-selector' | 'clean-scoped-locator' | 'proven-structural-fallback' | 'proof-only-no-clean-render' | 'blocked-unsafe-render';
...
export type BoundedFieldControlKind = 'input' | 'textarea' | 'select' | 'custom-trigger' | 'combobox' | 'searchbox' | 'contenteditable' | 'unknown';
export type BoundedFieldRelation = 'label-for' | 'wrapped-label' | 'aria-labelledby' | 'sibling-label' | 'bounded-container';
...
export type FlatSelectorEngine = 'css' | 'xpath' | 'text' | 'testid' | 'role' | 'label' | 'placeholder' | 'playwright' | 'label-context' | 'trigger-context';
export type ScopedSelectorRelation = 'parent-child' | 'bounded-field' | 'component-boundary';
...
export type PlaywrightLocatorKind = 'locator' | 'getByRole' | 'getByLabel' | 'getByPlaceholder' | 'getByText' | 'getByTestId';
...
export type SelectorSpec = FlatSelectorSpec | ScopedSelectorSpec | BoundedFieldStructuredSelectorSpec;
export type SelectorCategory = 'testid' | 'data-cy' | 'data-qa' | 'id' | 'name' | 'href' | 'placeholder' | 'aria-label' | 'role-attr' | 'text' | 'bounded-field' | 'label-context' | 'class' | 'semantic-css' | 'parent-scoped' | 'structural' | 'xpath' | 'llm' | 'unknown';
export type SelectorProofSource = 'snapshot' | 'fingerprint' | 'semantic' | 'llm-validator' | 'recorded' | 'smoke' | 'none';
export type EquivalentRenderingEngine = 'testid' | 'placeholder' | 'text' | 'role' | 'label' | 'playwright';
export type EquivalentRenderingProofLevel = 'proven_equivalent' | 'live_smoke_validated' | 'recorded';
export type EquivalentRenderingProofSource = 'attribute-equivalence' | 'text-equivalence' | 'accessibility-recorded' | 'smoke' | 'manual';
...
export type ResolverResolvedBy = 'kept-original' | 'deterministic-override' | 'blocked-semantic-mismatch' | 'blocked-snapshot-target-missing' | 'blocked-unsafe-override' | 'llm-accepted' | 'unresolved';
export interface RejectedCandidateTrace {
    selector: string;
    reason: string;
}
export type ShadowEvaluationStatus = 'computed' | 'skipped-no-candidates' | 'skipped-no-snapshot' | 'failed';
...
export type LlmResponseFormat = 'legacy-selector' | 'legacy-selectors' | 'candidates-v2';
export interface LlmRejectedCandidateTrace {
    selector: string;
    rejectReason: string;
}
export type TemporalClass = 'pre_action' | 'action_local' | 'post_action' | 'outcome_state' | 'unknown';
export type ResolverSnapshotSource = 'event-local-pageState' | 'event-local-pageSnapshot' | 'source-node-snapshot' | 'interaction-context-exact' | 'interaction-context-stable-by-url' | 'interaction-context-any-by-url' | 'outcome-event-snapshot' | 'destination-node-snapshot' | 'url-event-fallback' | 'latest' | 'latest-stable' | 'unavailable';
...
export interface ResolverMetadata {
    ...
    llmRetryStatus?: 'not-eligible' | 'triggered' | 'accepted' | 'rejected' | 'skipped-provider-error' | 'skipped-timeout' | 'skipped-empty-response';
    rejectReason: string | null;
...
export type CapturedSelectorCandidateFamily = 'primary' | 'test-id' | 'id' | 'name' | 'placeholder' | 'aria-label' | 'href' | 'role-attr' | 'text' | 'class' | 'parent-scoped-css' | 'tight-container-css';
...
export interface AccessibilityEvidence {
    ...
    accessibleNameSource?: 'aria-label' | 'aria-labelledby' | 'label-for' | 'wrapped-label' | 'button-text' | 'link-text' | 'placeholder' | 'title' | 'role-text' | 'none';
    labelText?: string | null;
    labelledByIds?: string[];
    isNativeLabelAssociation?: boolean;
}
export type TargetIdentitySource = 'pageState' | 'pageSnapshot' | 'interactionContext';
export type TargetIdentityStatus = 'emitted' | 'target-not-element' | 'target-detached' | 'target-not-in-snapshot' | 'shadow-not-serialized' | 'cross-origin-frame' | 'unsupported';
...
export type AssertionType = 'url' | 'element_visible' | 'element_text' | 'title' | 'custom';
export type AssertionSource = 'anchor' | 'url_change' | 'user_defined';
